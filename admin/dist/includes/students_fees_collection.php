        ...
        <div class="container-fluid">
            ...
            ?>
                ...
                <div class="ledger">
                    ...
                    <h3 class="heading">Student Vise Fees Collection Report</h3>
                    ...
                    <div class="container">
                        <table class="table table-bordered" id="item_table">
                            ...
                            $sql = "SELECT * FROM `collectiona` WHERE `date` BETWEEN '$from' AND '$to_1' AND `std_id`=$std_id ORDER BY `date`";
            ...
            ?>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="container mt-1">
                        <form action="students_fees_collection.php" method="post">

                            <table class="add">
                                <tbody>
                                    <tr>
                                        <th> <label for="student">Student Name</label></th>
                                        <td><select name="name" id="name" class="form-control chosen">
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                $name = $row['name'];
                                                $id = $row['id'];
                                                echo '<option value="' . $id . '"><p>' . $name . '</p></option>';
                                            }
                                            ?>
                                        </select></td>
                                    </tr>
