...
if (isset($_POST['std_vise'])) {
    ...
    header('Location: http://localhost/schoolManagementSystem/admin/dist/php/id_card.php?id=' . $std_id);
    
}
if(isset($_POST['class_vise'])){
    $class = $_POST['class'];
    header('Location: http://localhost/schoolManagementSystem/admin/dist/php/id_card_class.php?class=' . $class);
